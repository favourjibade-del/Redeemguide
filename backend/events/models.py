...
class Event(models.Model):
    ...
    location = models.ForeignKey('locations.Location', on_delete=models.SET_NULL, null=True, blank=True, related_name='events')
    manual_location = models.CharField(max_length=255, blank=True)
